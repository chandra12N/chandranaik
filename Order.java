...
public class Order {
    ...
    public void orders() throws InterruptedException
    {
        ...
        driver.findElement(By.xpath("//input[@id='inputFirstName']")).sendKeys("chandra");
        driver.findElement(By.xpath("//body/div[@class='container']/div[1]/div[2]/form[1]/div[1]/div[2]/input")).sendKeys("naik");
        driver.findElement(By.id("inputEmail")).sendKeys("chandra12@gmail.com");
        driver.findElement(By.id("inputPassword")).sendKeys("Chandra@12");
        driver.findElement(By.id("flexRadioDefault1")).click();
        driver.findElement(By.xpath("//input[@type='number']")).sendKeys("9848022118");
        driver.findElement(By.id(" address1")).sendKeys("manyatha tech park");
